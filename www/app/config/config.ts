...
// RECOMMENDED:specify yours CLOUD EXECUTE URL after deploying ./cloud-run-worker
export const CLOUD_EXECUTE_URL = process.env.CLOUD_EXECUTE_URL || "https://cloud-run-worker-313568160682.us-central1.run.app/compute";
